class Comic < Linkbot::Plugin
  ...
  def on_message(message, matches)
    ...
    1.upto(times) do
      ...
      doc = ActiveSupport::JSON.decode(http_get(subreddit, "User-Agent" => "Linkbot", "Cookie" => "reddit_session=8390507%2C2011-03-22T07%3A06%3A44%2C2516dcc69a22ad297b9900cbde147b365203bbbb"))
